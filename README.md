...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-k2yot8e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-k2yot8e.containers.anotherwebservice.com/
...
```
git clone git@github.com:x35gaming/container-k2yot8e.git
cd container-k2yot8e
```
...
```
docker attach container-k2yot8e
```
